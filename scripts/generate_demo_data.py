...
NINGXIA_CONTENTS = [
    "某地移动用户反映，被无故暂停通信功能，当地反诈中心核实后确认为误封。",
    "石嘴山市移动用户投诉反诈系统误判，要求恢复号码正常使用。",
    "某联通用户反馈，收到反诈提醒短信后号码被限制，当地反诈中心正在核查。",
    "反诈中心发布通告，近期将对异常号码进行集中清理，请用户配合核实。",
    "移动反诈专项行动开展以来，已关停涉诈号码XXX个，同时也收到多起误封投诉。",
    "某市用户反映，因频繁拨打外地号码被移动停机，当地反诈中心表示将优化判定模型。",
    "移动用户反映，号码被停机后影响正常生活，希望运营商能优化判定机制。",
    "某市用户投诉移动反诈系统误判，营业厅表示将加急处理。",
    "反诈中心提醒：接到陌生电话要提高警惕，如有疑问可拨打96110咨询。",
    "某市移动用户反映，因工作需要频繁拨打电话被停机，希望运营商能区分正常业务和诈骗行为。",
]
